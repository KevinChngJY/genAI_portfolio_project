    ...
    r = llm.chat.completions.create(
        ...
        messages=[
            {"role":"system","content":
             ...
             "If you are unsure or cannot describe the company, mark company_known='Not Sure'. "
             "Must be strict to confirm you know the company,then mark company_known='Yes' else 'Not Sure'. "
